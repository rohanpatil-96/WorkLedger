          ...
          <form onSubmit={handleSave} className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-blue/30 min-h-[70px]"
              />
            </div>
            ...
            <form onSubmit={handleBulkApplyRange} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-slate-800 text-xs focus:outline-none focus:ring-1 focus:ring-brand-blue"
                />
              </div>
