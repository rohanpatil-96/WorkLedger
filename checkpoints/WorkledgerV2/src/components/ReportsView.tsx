    ...
    <div className="space-y-6 max-w-5xl mx-auto" id="reports-exporting-workspace">
      ...
      <div className="hidden print:flex fixed bottom-[0.4in] left-[0.6in] right-[0.6in] justify-between items-center border-t border-[#2C3639]/10 pt-3" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
        <span className="italic text-[9px] text-[#8C7C6B]">
          Generated by WorkLedger Denmark • Report Date: {new Date('2026-06-27').toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}
        </span>
      ...
      >
                    ...
                    <div className="hidden print:grid grid-cols-3 gap-3 mt-6 border-t border-slate-100 dark:border-slate-800/50 pt-5 text-xs print-grid-3">
                      <div className="bg-slate-50/50 dark:bg-slate-900/30 border border-slate-200/60 dark:border-slate-800 p-3.5 rounded-xl flex flex-col justify-between print-inverted-window">
                        ...
                        <div>
                          ...
                          <span className="text-slate-505 dark:text-slate-400 block text-[10px] mt-0.5">{settings.userName ? `${settings.userName.toLowerCase().replace(/\s+/g, '')}@gmail.com` : 'rohanpatil96@gmail.com'}</span>
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 print-grid-4">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3 relative overflow-hidden print-inverted-window print-avoid-break">
                      ...
                      <div className="flex justify-between items-start">
                        <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Overtime Summary</span>
                  ...
                  <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm print-inverted-window print-avoid-break">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4">
                      ...
                      <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/60 space-y-1 shadow-xs print-inner-card">
                        ...
                        <div className="font-mono text-base font-extrabold text-slate-805 print-text-primary">
                      ...
                      <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/60 space-y-1 shadow-xs print-inner-card">
                        ...
                        <div className="font-mono text-base font-extrabold text-slate-808 print-text-primary">
                ...
                <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800 print:border-none print:pt-0">
                  <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 print:hidden animate-fade-in">
                    <h4 className="text-[11px] font-bold text-slate-505 uppercase tracking-widest">
                      Chronological Statement of Workdays
                    </h4>
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="px-3.5 py-1.5 bg-slate-55 dark:bg-slate-800 border border-slate-205 dark:border-slate-705 text-xs font-bold text-slate-707 dark:text-slate-200 rounded-xl shadow-xs select-none">
                      ...
                      <button
                        ...
                        className="px-3.5 py-1.5 bg-slate-55 dark:bg-slate-800 border border-slate-205 dark:border-slate-705 text-xs font-bold text-slate-707 dark:text-slate-200 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700 transition flex items-center gap-1.5 cursor-pointer shadow-xs select-none"
                      >
                  ...
                  <h4 className="text-[11px] font-bold text-slate-505 uppercase tracking-widest hidden print:block">
                  ...
                  <div className={`${showChronologicalStatement ? 'block' : 'hidden print:block'} space-y-6`}>
                    {useMemo(() => {
                      ...
                      >
                        <div className="flex justify-between items-center border-b border-slate-101 dark:border-slate-800/60 pb-2">
                          ...
                          <span className="text-[10px] font-mono px-2 py-0.5 bg-slate-105 dark:bg-slate-800 text-slate-707 dark:text-slate-300 rounded font-bold print-inner-card">
                            ...
                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50 text-slate-700 dark:text-slate-350 font-semibold">
                              {group.entries.map((e) => (
                                <tr key={e.date} className="break-inside-avoid hover:bg-slate-50/40 dark:hover:bg-slate-800/30">
                                  <td className="p-2.5 font-mono whitespace-nowrap text-slate-808 dark:text-slate-200 font-bold text-[11px] print-text-primary">{e.date}</td>
                                  ...
                                  <td className="p-2.5 text-center font-bold font-mono text-slate-808 dark:text-slate-200 text-[11px] print-text-primary">{e.finalCountedHours.toFixed(2)} hrs</td>
                                  <td className="p-2.5 text-center font-bold font-mono">
                                    <span className={e.overtime > 0 ? 'text-[#73825E] dark:text-[#8A9A76] print-overtime-positive' : e.overtime < 0 ? 'text-rose-600 font-bold print-overtime-negative' : 'text-slate-404'}>
                    ...
                    {useMemo(() => reportEntries.filter(e => e.category === WorkCategory.Office).length, [reportEntries]) === 0 && (
                      <div className="text-center py-8 text-slate-400 dark:text-slate-505 italic font-medium bg-slate-50 dark:bg-slate-900/10 border border-slate-200 dark:border-slate-800 rounded-xl print-inverted-window">
