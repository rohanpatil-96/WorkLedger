    ...
    <div className="space-y-6" id="dashboard-analytical-workspace">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white border border-slate-200 p-5 rounded-2xl gap-3 shadow-sm">
        ...
        <div className="flex gap-2 items-center">
          <span className="text-xs text-slate-505 font-semibold uppercase tracking-wider">Select Year:</span>
          <select
            value={selectedYear}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3 relative overflow-hidden" id="overtime-total-balance-card">
          ...
          <div className="flex justify-between items-start">
            <span className="text-xs font-semibold text-slate-505 uppercase tracking-wider">Overtime Balance</span>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3 relative overflow-hidden" id="in-office-days-tax-card">
          <div className="absolute top-0 right-0 w-24 h-24 bg-brand-blue/5 rounded-full blur-xl pointer-events-none" />
          <div className="flex justify-between items-start">
            <span className="text-xs font-semibold text-slate-505 uppercase tracking-wider">In Office Days (Tax Deductible)</span>
            <span className="bg-brand-blue/10 text-brand-blue p-1.5 rounded-lg">
          ...
          <div className="border-t border-slate-100 pt-2 text-[10px] text-slate-505 flex items-center gap-1 leading-tight text-slate-500 font-medium">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3 relative overflow-hidden" id="wfh-tax-documentation-card">
          ...
          <div className="flex justify-between items-start">
            <span className="text-xs font-semibold text-slate-505 uppercase tracking-wider">WFH Days</span>
          ...
          <p className="border-t border-slate-100 pt-2 text-[10px] text-slate-505 leading-normal flex items-center gap-1 text-slate-550 font-medium">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3 relative overflow-hidden" id="skat-commute-refund-card">
          ...
          <div className="flex justify-between items-start">
            <span className="text-xs font-semibold text-slate-505 uppercase tracking-wider">Est Commute Deduction</span>
          ...
          <div className="border-t border-slate-100 pt-2 text-[9px] text-slate-550 flex flex-col gap-0.5 leading-tight font-medium">
        ...
        <div className="space-y-6" id="collapsible-visuals-sections-wrapper">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm space-y-4">
              <h4 className="text-xs font-extrabold text-slate-505 uppercase tracking-wider flex items-center justify-between">
            ...
            <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-sm space-y-4">
              <h4 className="text-xs font-extrabold text-slate-555 uppercase tracking-wider flex items-center justify-between">
                <span>Monthly Overtime Log ({selectedYear})</span>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                  {categoryShares.map((share, i) => {
                    if (share.count === 0) return null;
                    return (
                      <div key={i} className="flex items-center gap-2 text-slate-650">
